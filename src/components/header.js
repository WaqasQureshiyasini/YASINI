    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        <li className="nav-item">
          <a className="nav-link" aria-current="page" href="/YellowGold">Yellow Gold Jewelry</a>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="/WhiteGold">White Gold Jewelry</a>
        </li>
        <li className="nav-item">
          <a className="nav-link" href="/YellowGold/Coins_&_Bullion">Gold Bullion</a>
        </li>
        <li className="nav-item">
        <a className="nav-link" href="/Diamond">Diamond Jewelry</a>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item">
        <a className="nav-link" href="/Lazurde">L'azurde</a>
        </li>
      </ul>
    </div>
  </div>
