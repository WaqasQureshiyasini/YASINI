        ...
        <div>
            ...
            <>
                <div className="subheader ">
                    <h1 className="">Lazurde Jewelry</h1>
                    <div className="breadcrum "><a href="/">Home</a> <i className="fa fa-angle-double-right"></i> Lazurde Jewelery</div>
                </div>
...
export async function getStaticProps() {
    const res = await fetch(`https://yasini.com/yasiniapi/api/category/parent/182`)
