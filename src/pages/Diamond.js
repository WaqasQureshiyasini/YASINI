        ...
        <div>
            ...
            <>
                <div className="subheader ">
                    <h1 className="">Diamond Jewelry</h1>
                    <div className="breadcrum "><a href="/">Home</a> <i className="fa fa-angle-double-right"></i> Diamond Jewelery</div>
                </div>
...
export async function getStaticProps() {
    const res = await fetch(`https://yasini.com/yasiniapi/api/category/parent/2`)
