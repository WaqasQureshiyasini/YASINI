...
const pageTitle = "WhiteGold"
const WhiteGold = ({ items }) => {
    return (
        <div>
            ...
            <>
                <div className="subheader ">
                    <h1 className="">White Gold Jewelry</h1>
                    <div className="breadcrum "><a href="/">Home</a> <i className="fa fa-angle-double-right"></i> White Gold Jewelery</div>
                </div>
...
// WhiteGold.getStaticProps = async (ctx) => {
//     const res = await fetch(`https://yasini.com/yasiniapi/api/category/parent/5`);
